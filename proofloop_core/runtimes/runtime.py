...
CONTROLLER_ROUTES: dict[str, dict[str, RoleRoute]] = {
    "claude-code": {
        ...
        "classifier_fast": RoleRoute("claude-code", "haiku", "low", "read-only"),
    },
    "codex": {
        ...
        "classifier_fast": RoleRoute("codex", "gpt-5.6-terra", "low", "read-only"),
    },
    "agy": {
        ...
        "classifier_fast": RoleRoute("agy", "gemini-3.5-flash-medium", "low", "read-only"),
    },
    "antigravity": {
        "planner_deep": RoleRoute("antigravity", "gemini-3.1-pro-high", "high", "read-only"),
        "explorer_fast": RoleRoute("antigravity", "gemini-3.5-flash-medium", "low", "read-only"),
        "implementer_fast": RoleRoute("antigravity", "gemini-3.5-flash-medium", "medium", "workspace-write"),
        "implementer_recovery": RoleRoute("antigravity", "gemini-3.1-pro-high", "high", "workspace-write"),
        "reviewer_deep": RoleRoute("antigravity", "gemini-3.1-pro-high", "high", "read-only"),
        "classifier_fast": RoleRoute("antigravity", "gemini-3.5-flash-medium", "low", "read-only"),
    },
}
...
def runtime_spec(runtime_id: str) -> RuntimeSpec:
    if runtime_id == "antigravity":
        return RUNTIME_SPECS["antigravity"]
    try:
