...
from proofloop_core.analysis.benchmark_environment import SWETrialEnvironment, materialize_repository
from proofloop_core.runtimes.host_runner import invoke_role
from proofloop_core.context.io import read_json, write_json
from proofloop_core.engine.orchestrator import converge_goal, run_proofloop
...
def run_benchmark(
    ...
    *,
    ...
    if resume:
        ...
        previous_manifest = read_json(root / "manifest.json")
